...
class DecorationEquipmentIssue extends Model
{
    use LogsActivity, SoftDeletes;

    protected $table = 'decoration_equipment_issues';
    ...
    {
        return $this->hasMany(DecorationEquipmentIssueItem::class, 'issue_id');
    }
    ...
    {
        $reserved = ['create', 'edit', 'data', 'index', 'items', 'confirm'];
