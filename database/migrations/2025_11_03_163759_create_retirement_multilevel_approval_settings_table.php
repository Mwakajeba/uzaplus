...
return new class extends Migration
{
    ...
    {
        Schema::create('retirement_multilevel_approval_settings', function (Blueprint $table) {
            $table->id();
            ...
            // Indexes
            $table->unique(['company_id', 'branch_id'], 'ret_approval_settings_unique');
    ...
    {
        Schema::dropIfExists('retirement_multilevel_approval_settings');
    }
};
