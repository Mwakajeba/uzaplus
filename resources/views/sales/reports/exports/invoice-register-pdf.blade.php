...
<head>
    ...
    <style>
        ...
        .data-table th:nth-child(4) { width: 7%; }   /* Status */
        .data-table th:nth-child(5) { width: 10%; }  /* Total */
        .data-table th:nth-child(6) { width: 10%; }  /* Paid */
        .data-table th:nth-child(7) { width: 10%; }  /* Outstanding */
        .data-table th:nth-child(8) { width: 22%; }  /* Created By */
            ...
            <tbody>
                @foreach($invoices as $invoice)
                    ...
                    <tr>
                        ...
                        <td>{{ $invoice->createdBy->name ?? 'Unknown' }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
