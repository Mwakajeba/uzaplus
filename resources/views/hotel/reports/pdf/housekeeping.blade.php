...
<head>
    ...
    <style>
        ...
        .header { margin-bottom: 20px; border-bottom: 3px solid #212529; padding-bottom: 15px; }
        .header-content {
            display: flex;
        ...
        .header h1 { color: #212529; margin: 0; font-size: 24px; font-weight: bold; }
        ...
        table.data-table th { background-color: #212529; color: white; font-weight: bold; text-align: left; }
...
<body>
    ...
    <div class="footer">
        <p>Housekeeping Report - Generated on {{ $generatedAt->format('d M Y H:i') }}</p>
    </div>
</body>
</html>
