...
<head>
    ...
    <style>
        ...
        .header { margin-bottom: 20px; border-bottom: 3px solid #6c757d; padding-bottom: 15px; }
        .header-content {
            display: flex;
        ...
        table.data-table th { background-color: #6c757d; color: white; font-weight: bold; text-align: left; }
...
<body>
    ...
    <div class="footer">
        <p>Room Status Report - Generated on {{ $generatedAt->format('d M Y H:i') }}</p>
    </div>
</body>
</html>
