...
@section('title', 'Bank Reconciliation Approval History')
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">BANK RECONCILIATION APPROVAL HISTORY</h6>
        <hr />
                ...
                <div class="card radius-10">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h6 class="mb-0">Bank Reconciliation: {{ $bankReconciliation->bankAccount->name }} - {{ $bankReconciliation->formatted_reconciliation_date }}</h6>
                            <a href="{{ route('accounting.bank-reconciliation.show', $bankReconciliation) }}" class="btn btn-secondary btn-sm">
                                <i class="bx bx-arrow-back me-1"></i>Back to Reconciliation
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
