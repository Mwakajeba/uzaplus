...
<head>
    ...
    <title>Inventory Profit Margin Report</title>
    <style>
        body {
        ...
        .data-table th:nth-child(8) { width: 14%; }
...
<body>
    <div class="header">
        <div class="header-content">
            ...
            <div class="title-section">
                <h1>Inventory Profit Margin Report</h1>
                @if($company)
    ...
    @if($reportData->count() > 0)
        @php
            ...
            $totalSales = $reportData->sum('sales_value');
        ...
        <table class="data-table">
            <thead>
                <tr>
                    ...
                    <th class="number">Sales Value (TZS)</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="number">{{ number_format($data['sales_value'], 2) }}</td>
