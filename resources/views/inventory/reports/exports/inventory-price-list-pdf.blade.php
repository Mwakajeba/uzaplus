...
<head>
    ...
    <title>Inventory Price List Report</title>
    <style>
        body {
    ...
    <div class="header">
        <div class="header-content">
            ...
            <div class="title-section">
                <h1>Inventory Price List Report</h1>
                @if($company)
        ...
        <table class="data-table">
            <thead>
                <tr>
                    ...
                    <th>Item Name</th>
                    <th>Category</th>
                    <th class="number">Unit Cost (TZS)</th>
                    <th class="number">Selling Price (TZS)</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="number">{{ number_format($data['selling_price'], 2) }}</td>
                    <td class="number">{{ number_format($data['markup'], 2) }}%</td>
                </tr>
                @endforeach
            </tbody>
        </table>
