    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0"><i class="bx bx-building me-2"></i>Edit Property: {{ $property->name }}</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('properties.update', $property) }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="type" 
                                    ...
                                    <option value="office" {{ old('type', $property->type) == 'office' ? 'selected' : '' }}>Office Building</option>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       placeholder="Country" 
                                       value="{{ old('country', $property->country ?? 'Tanzania') }}">
                                @error('country')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea name="description" 
                                          ...
                                          rows="4" 
                                          placeholder="Property description, features, amenities, etc.">{{ old('description', $property->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="d-flex gap-2 justify-content-end">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bx bx-check me-1"></i>Update Property
                        </button>
                    </div>
                </form>
            </div>
