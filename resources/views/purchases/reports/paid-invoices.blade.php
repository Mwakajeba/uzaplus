...
@section('title','Paid Supplier Invoice Report')
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h4 class="card-title mb-0">
                                <i class="bx bx-check-circle me-2"></i>Paid Supplier Invoice Report
                            </h4>
                        </div>
                        ...
                        <form method="GET" class="row g-3 mb-4">
                            ...
                            <div class="col-12 text-end">
                                ...
                                <a href="{{ route('purchases.reports.paid-invoices') }}" class="btn btn-outline-secondary">Reset</a>
                            </div>
                        </form>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                <div class="card border border-success">
                                    <div class="card-body text-center">
                                        <h5 class="card-title text-success">Total Paid Invoices</h5>
                            ...
                            <div class="col-md-6">
                                <div class="card border border-primary">
                                    <div class="card-body text-center">
                                        <h5 class="card-title text-primary">Total Paid Value</h5>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="6" class="text-center text-muted">No paid invoices found.</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                                @if(count($invoices) > 0)
                                <tfoot class="table-light">
                                    <tr>
                                        ...
                                        <td class="text-end fw-bold">{{ number_format($summary['total_paid_value'], 2) }} TZS</td>
                                        <td colspan="2"></td>
                                        <td class="text-end fw-bold text-success">{{ number_format($summary['total_paid_value'], 2) }} TZS</td>
                                    </tr>
                                </tfoot>
                                @endif
                            </table>
