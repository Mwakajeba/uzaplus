...
@section('title', 'Add Payment - Rental Invoice')
...
<div class="page-wrapper">
    <div class="page-content">
        <x-breadcrumbs-with-icons :links="[
            ...
            ['label' => 'Add Payment', 'url' => '#', 'icon' => 'bx bx-money']
        ]" />
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-success text-white">
                        <h5 class="mb-0"><i class="bx bx-money me-2"></i>Record Payment</h5>
                    </div>
                    <div class="card-body">
                        <!-- Invoice Summary -->
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p class="mb-0"><strong>Balance Due:</strong> <span class="badge bg-warning">TZS {{ number_format($balanceDue, 2) }}</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>

                        <form method="POST" action="{{ route('rental-event-equipment.rental-invoices.payment.store', $invoice->getRouteKey()) }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="payment_amount" name="payment_amount" 
                                            value="{{ $balanceDue }}" min="0.01" max="{{ $balanceDue }}" step="0.01" required>
...
$(document).ready(function() {
    ...
    // Payment method is always bank_transfer, so bank account is always required
});
</script>
@endpush
