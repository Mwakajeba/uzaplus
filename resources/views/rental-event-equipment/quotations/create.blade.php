...
@section('title', 'Create Rental Quotation')
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">CREATE RENTAL QUOTATION</h6>
        <hr />

        <div class="card">
            <div class="card-header bg-success text-white">
                <h5 class="mb-0"><i class="bx bx-file-blank me-2"></i>New Rental Quotation</h5>
            </div>
            <div class="card-body">
                <form id="quotation-form" method="POST" action="{{ route('rental-event-equipment.quotations.store') }}">
                    @csrf
                    <div class="row">
                                        ...
                                        <tr>
                                            <td colspan="4" class="text-end">
                                                ...
                                                <input type="number" class="form-control form-control-sm d-inline-block ms-2" style="width: 120px;" 
                                                       id="discount_amount" name="discount_amount" value="0" step="0.01" min="0" placeholder="0.00">
                                            </td>
                    ...
                    <div class="d-flex gap-2 justify-content-end mt-4">
                        <a href="{{ route('rental-event-equipment.quotations.index') }}" class="btn btn-outline-secondary">
...
$(document).ready(function() {
    ...
    $('#quotation-form').on('submit', function(e) {
        ...
        $.ajax({
            ...
            error: function(xhr) {
                submitBtn.prop('disabled', false).html('<i class="bx bx-check me-1"></i>Create Quotation');
