...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h5 class="mb-0 text-primary">Edit Cash Deposit Withdrawal</h5>

        <hr>

        <div class="card">
            <div class="card-body">
                <form action="{{ route('payments.update', Hashids::encode($payment->id)) }}" method="POST" id="payment-form">
                    @csrf
                    @method('PUT')
    ...
    $(document).ready(function() {
        ...
        function checkPeriodLock(date, onResult) {
            ...
            $.ajax({
                ...
                error: function() {
                    // Fail silently – backend validation will still block GL posting
        ...
        // Prevent submit if date is in locked period
